...
defmodule About_Tuples do
    ...
    think "Setting a tuple element that not exists raise an argument error" do
        ...
        assert_raise ArgumentError, fn -> set_elem(a_tuple, 2, :baz) end
    end
    ...
    think "The building blocks of Elixir are tuples of three elements" do
        ...
        assert size(quoted_block) == 3
    end

    # TODO Make it work: (CompileError) about_tuples.exs:68: unquote called outside quote
